...
import (
	...
	"github.com/epmd-edp/jenkins-operator/v2/pkg/service/jenkins_job/chain/handler"
...
func CreateDefChain(s *runtime.Scheme, c *client.Client) (handler.JenkinsJobHandler, error) {
...
func nextServeOrNil(next handler.JenkinsJobHandler, jj *v1alpha1.JenkinsJob) error {
	if next != nil {
