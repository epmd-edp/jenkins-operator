...
func (j JenkinsServiceImpl) Configure(instance v1alpha1.Jenkins) (*v1alpha1.Jenkins, bool, error) {
	...
	jobNames := []string{defaultCiJobProvisionsDirectory, defaultCdJobProvisionsDirectory}
	for _, jobName := range jobNames {
		err = j.createJobProvisions(fmt.Sprintf("%v/%v", defaultJobProvisionsDirectory, jobName), jc, instance)
		if err != nil {
			return &instance, false, err
		}
	}
