...
4. Generate and add a new SSH key to your Github account. More about this in [the official documentation from Github](https://help.github.com/en/github/authenticating-to-github/adding-a-new-ssh-key-to-your-github-account).
_**NOTE**: This should be the same SSH key, that you added to your GitServer definition._

5. Add a private part of an SSH key to Jenkins by navigating to Jenkins -> Credentials -> System -> Global credentials -> Add credentials, and create a new credentials with *SSH username with private key* kind
